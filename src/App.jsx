...
const DATA = {
  ...
  socials: [
    { label: "GitHub",    url: "https://github.com/username",          icon: "GH" },
    { label: "Facebook",  url: "https://facebook.com/username",        icon: "FB" },
    { label: "LinkedIn",  url: "https://linkedin.com/in/username",     icon: "LI" },
    { label: "Email",     url: "mailto:email@example.com",             icon: "@"  },
  ],
  about:
    "Seorang developer dengan passion di product engineering. Senang eksplorasi teknologi baru, menulis kode yang maintainable, dan membangun produk yang benar-benar berguna.",
  experience: [
    {
      company: "PT. Tech Startup",
      role: "Senior Frontend Developer",
      period: "2022 — Sekarang",
      desc: "Memimpin pengembangan frontend untuk platform SaaS B2B. Stack: React, TypeScript, TailwindCSS.",
    },
    {
      company: "Digital Agency XYZ",
      role: "Fullstack Developer",
      period: "2020 — 2022",
      desc: "Membangun berbagai web app untuk klien skala menengah. Stack: Next.js, Node.js, PostgreSQL.",
    },
    {
      company: "Freelance",
      role: "Web Developer",
      period: "2018 — 2020",
      desc: "Mengerjakan proyek freelance dari landing page hingga e-commerce kecil.",
    },
  ],
  projects: [
    {
    ...
    },
    {
      ...
      desc: "CLI tool untuk automate workflow development sehari-hari.",
      link: "#",
    },
    {
      name: "Open API Wrapper",
      tech: ["TypeScript", "REST"],
      desc: "Library wrapper untuk integrasi beberapa third-party API.",
      link: "#",
    },
    {
      name: "Portfolio v1",
      tech: ["HTML", "CSS", "JS"],
      desc: "Website portofolio pertama. Sekarang sudah digantikan yang ini.",
      link: "#",
    },
  ],
};
